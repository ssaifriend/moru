...
export const registerAppCommands = (registry: CommandRegistry, ws: Workspace, ui: Ui): void => {
  registry.registerAll([
    ...
    { id: 'tab.moveToNextPane', title: 'Tab: Move to Next Pane', run: () => ws.moveActiveTab(1) },
    { id: 'tab.moveToPrevPane', title: 'Tab: Move to Previous Pane', run: () => ws.moveActiveTab(-1) },
    { id: 'tab.moveToNewWindow', title: 'Tab: Move to New Window', run: () => void ws.detachTab() },
