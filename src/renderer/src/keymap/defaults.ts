...
const common: readonly Binding[] = [
  ...
  { keys: 'mod+alt+]', command: 'markdown.headingUp', when: "languageId == 'markdown' && editorFocus" },
  { keys: 'mod+alt+[', command: 'markdown.headingDown', when: "languageId == 'markdown' && editorFocus" },
  ...
  { keys: 'mod+shift+]', command: 'tab.next' },
  { keys: 'mod+shift+[', command: 'tab.prev' },
  { keys: 'mod+alt+arrowright', command: 'tab.next' },
...
const mac: readonly Binding[] = [
  ...
  { keys: 'ctrl+mod+arrowright', command: 'tab.moveToNextPane' },
  { keys: 'ctrl+mod+arrowleft', command: 'tab.moveToPrevPane' },
...
const win: readonly Binding[] = [
  ...
  { keys: 'ctrl+alt+shift+arrowright', command: 'tab.moveToNextPane' },
  { keys: 'ctrl+alt+shift+arrowleft', command: 'tab.moveToPrevPane' },
