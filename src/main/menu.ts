  ...
  const template: MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { type: 'separator' },
        command('Move Tab to Next Pane', 'tab.moveToNextPane'),
        command('Move Tab to Previous Pane', 'tab.moveToPrevPane'),
        command('Move Tab to New Window', 'tab.moveToNewWindow'),
        { type: 'separator' },
